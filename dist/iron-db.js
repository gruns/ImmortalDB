...
// EXTERNAL MODULE: ./node_modules/lodash.last/index.js
var lodash_last = __webpack_require__(6);

// EXTERNAL MODULE: ./node_modules/lodash.sortby/index.js
var lodash_sortby = __webpack_require__(3);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IronDB", function() { return IronDB; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IronStorage", function() { return src_IronStorage; });
...
class src_IronStorage {
    ...
    async get (key, _default=null) {
        ...
        const sorted = lodash_sortby_default()(counted, i => i[1]).reverse()

        let value = undefined
        const [firstValue, firstCount] = lodash_get_default()(sorted, '[0]', [undefined, 0])
        const [secondValue, secondCount] = lodash_get_default()(sorted, '[1]', [undefined, 0])
