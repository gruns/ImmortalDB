...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(4), __webpack_require__(3)(module)))
...
class src_IronStorage {
    ...
    async get (key, _default=null) {
        ...
        const sorted = Object(lodash["sortBy"])(counted, i => i[1]).reverse()

        let value = undefined
        const [firstValue, firstCount] = Object(lodash["get"])(sorted, '[0]', [undefined, 0])
        const [secondValue, secondCount] = Object(lodash["get"])(sorted, '[1]', [undefined, 0])
